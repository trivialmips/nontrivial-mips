...
set_output_delay 0 -clock ui_clk* [get_ports [list num_* led* UART_txd MII_rst_n DDR3_reset_n PS2_*]]
set_false_path -to [get_ports [list num_* led* btn* switch* UART_txd MII_rst_n DDR3_reset_n PS2_*]]

set_input_delay 0 -clock ui_clk* [get_ports [list btn* switch* rst_n UART_rxd PS2_*]]
